...
// ++++++++++++++++++++++++++++
  ...
  $('.main-menu-container a').click(function()
  {
    ...
    $('.main-menu-container a').css({'background': 'url(images/separator.png) no-repeat', 'background-position': 'right'});
    return false;
  });
...
// ++++++++++++++++++++++++++++
   ...
   $('.main-menu-container a.cat-1').click(function()
  {
    ...
    $(this).parent().addClass('tabbed').prev('div').find('a').css({'background': 'transparent no-repeat', 'background-size': '100% 100%'});
    return false;
  });
...
// ++++++++++++++++++++++++++++
  ...
  {
    $('.user-info').toggle().removeClass('hidden-md hidden-sm hidden-xs').css({'padding' : '0 10px', 'height' : '30px'});
  });
  ...
  $('.header .next-btn').click(function()
    {
    $('.slider-info .slider-header').removeClass('active').css({'opacity':'0'}).animate({'opacity' : '1'}, 500);
    $('.slider-info .slide-text').removeClass('active').css({'opacity':'0'}).animate({'opacity' : '1'}, 500);
  });
